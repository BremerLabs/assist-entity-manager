...
class AssistEntityManager extends HTMLElement {
      ...
      <div class="detail-backdrop" role="presentation">
        <section class="detail-panel" role="dialog" aria-modal="true" aria-label="Entitätsdetails">
                                ...
                                ${
                                  unsupported
                                    ? `<small class="assistant-unsupported-text">
                                        ...
                                        Nicht unterstützt${
                                          isOn ? " – Ausschalten ist weiterhin möglich" : ""
                                        }
                                      </small>`
                                    : `<small>${
                                        isOn
                                          ? "Diese Entität ist freigegeben"
                                          : "Diese Entität ist nicht freigegeben"
                                      }</small>`
                                }
                              </div>
                            </div>
          ...
          <div class="detail-grid">
            ...
            <div class="detail-section">
              <h3>Zuordnung</h3>
              ${this._detailItem("Bereich", entity.areaName || "Kein Bereich")}
              ${this._detailItem("Gerät", entity.deviceName || "Kein Gerät")}
  ...
  async _setExposure(entityIds, shouldExpose, assistantIds = null) {
    ...
    if (!assistants.length) {
      this._error = "Kein aktivierter Sprachassistent für diese Aktion ausgewählt.";
      this._render();
      return;
    }
                            ...
                            >
                              ...
                              <span class="mini-switch">
                                <input
                                  ...
                                  aria-label="${this._escapeAttr(
                                    assistant.label
                                  )}-Freigabe für ${this._escapeAttr(entity.name)}"
                                >
                                <span class="mini-slider"></span>
                              </span>
                            </label>
